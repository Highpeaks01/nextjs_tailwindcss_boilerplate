...
const FEATURES_DATA = {
  plan: {
    title: 'Your magic tools',
    features: [
      {
        title: 'AI calls outbound',
        description: 'Human-Grade AI Calls to your prospects.',
      },
      {
        title: 'AI calls inbound',
        description: 'AI takes calls and manages your calendar even while you sleep.',
      },
      {
        title: 'Virtual staging',
        description: 'Add furniture to your shots in seconds.',
      },
      {
        title: 'Write listings',
        description: 'Write full listings from your photos.',
      },
      {
        title: 'Ownership check',
        description: 'Get the owner you\'re looking to in one click.',
      },
      {
        title: 'Document',
        description: 'Write transaction documents using AI.',
      },
    ],
  },
